let countries = ["Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla",
    ...
    // Menggunakan filter untuk menemukan negara yang berakhiran "sia"
let countriesEndingWithSia = countries.filter(country => country.endsWith("sia"));

// Menampilkan hasilnya di console
console.log("Negara yang berakhiran 'sia':", countriesEndingWithSia);

// Menampilkan hasil di halaman web
document.getElementById("output").innerText = "Negara yang berakhiran 'sia': " + countriesEndingWithSia.join(", ");